...
const Home = () => (
  <IconButton storageKey={KeyHomeButton} label="主页">
    <path
...
const Explore = () => (
  <IconButton storageKey={KeyExploreButton} label="探索">
    <path
      className="fill-current"
...
const Notifications = () => (
  <IconButton storageKey={KeyNotificationsButton} label="通知">
    <path
      className="fill-current"
...
const Messages = () => (
  <IconButton storageKey={KeyMessagesButton} label="私信">
    <path
      className="fill-current"
...
const Bookmarks = () => (
  <IconButton storageKey={KeyBookmarksButton} label="书签">
    <path
      className="fill-current"
...
const Articles = () => (
  <IconButton storageKey={KeyArticlesButton} label="文章">
    <path
      className="fill-current"
...
const Communities = () => (
  <IconButton storageKey={KeyCommunitiesButton} label="社群">
    <path
      className="fill-current"
...
const Lists = () => (
  <IconButton storageKey={KeyListsButton} label="列表">
    <path
      className="fill-current"
...
const Topics = () => (
  <IconButton storageKey={KeyTopicsButton} label="话题">
    <path
      className="fill-current"
...
const XPremium = () => (
  <IconButton storageKey={KeyXPremiumButton} label="会员">
    <path
      className="fill-current"
...
const VerifiedOrgs = () => (
  <IconButton storageKey={KeyVerifiedOrgsButton} label="认证组织">
...
const Profile = () => (
  <IconButton storageKey={KeyProfileButton} label="个人资料">
    <path
      className="fill-current"
...
const TypefullyGrow = () => (
  <IconButton storageKey={KeyTypefullyGrowTab} label="Typefully 分析">
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      fill="currentColor"
...
const Jobs = () => (
  <IconButton storageKey={KeyJobsButton} label="工作">
    <path
      className="fill-current"
...
const NavigationSection = () => {
  return (
    <section className="flex flex-col gap-y-2">
      <SectionLabel htmlFor="user-control-navigation">左侧导航</SectionLabel>
      <div id="user-control-navigation">
        <form className="p-3 pb-4 dark:bg-x-bgTwoDark bg-x-bgTwo rounded-2xl">
          ...
          <div className="flex flex-col gap-y-4">
            <Separator />
            <SwitchControl label="𝕏 标志" storageKey={KeySidebarLogo} />
            <div className="flex items-center gap-x-4">
              <span className="text-[15px] font-medium whitespace-nowrap">显示标签</span>
              <SegmentedControl
